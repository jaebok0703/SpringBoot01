package com.jbl.book.springboot.web.domain.posts;
...
// 2번 postsRepository.save
// - 테이블 posts에 insert/update 쿼리를 실행합니다.
// - id 값이 있다면 update가, 없다면 insert 쿼리가 실행 됩니다.

// 3번 postsRepository.findAll
